...
<HTML>
	<HEAD>
		<TITLE>Bluewega Travels Agent Registration form</TITLE>
	</HEAD>
	<BODY><BR>
	<html:form action="AgentReg">
	<TABLE WIDTH="100%" HEIGHT="30" BORDER="0">
		<TR>
			<TD WIDTH="2%">
			</TD>
			<TD>
				<FONT FACE="VERDANA" SIZE="+1" COLOR="#00366C"><B>Agent Registration</B></FONT>
			</TD>
			...
			<TD WIDTH="4%" ALIGN="RIGHT">
				<A HREF="AgentLogin.jsp" TITLE="To get Login Form" onMouseOver="window.status=('To get Login Form'); return true;" onMouseOut="window.status=(' '); return true;"><FONT FACE="VERDANA" SIZE="1" COLOR="#00366C"><B>Login</B></FONT></A>
			</TD>
	...
	<HR WIDTH="90%" SIZE="1" COLOR="#00366C">
			...
			<TABLE WIDTH="90%" ALIGN="CENTER" BORDER="0" CELLPADDING="4">
				...
				<TR>
					<TD WIDTH="32%" ALIGN="RIGHT">
						<FONT FACE="VERDANA" SIZE="2" COLOR="#004300"><B>Date of Registration : </B></FONT>
					</TD>
					<TD>
						<html:select property="drmonth">
				...
				<TR>
					<TD WIDTH="32%" ALIGN="RIGHT">
						<FONT FACE="VERDANA" SIZE="2" COLOR="#004300"><B><bean:message key="regno"/> : </B></FONT>
					</TD>
					<TD>
						<html:text property="regno"/><FONT COLOR=RED SIZE="2">*</FONT>
					</TD>
					<TD><html:errors property="regno"/></TD>
				</TR>
				<TR>
					<TD WIDTH="27%"></TD>
					<TD ALIGN="LEFT"><BR>
